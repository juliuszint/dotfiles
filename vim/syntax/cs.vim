...
syn region	csEnumType	start="@\@1<!\<enum\>"hs=s+5 end="[:\n{]"me=e-1 contains=csEnum
syn region	csStructType	start="@\@1<!\<struct\>"hs=s+7 end="[:\n{]"me=e-1 contains=csStruct
syn region	csInterfaceType	start="@\@1<!\<interface\>"hs=s+10 end="[:\n{]"me=e-1 contains=csInterface
...
syn keyword	csInterface	interface contained
syn keyword	csStruct	struct contained
syn keyword	csEnum	enum contained
...
hi def link	csEnum	StorageClass
hi def link	csInterface	StorageClass
hi def link	csStruct	StorageClass
