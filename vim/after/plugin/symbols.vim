...
command! CSymbols :call fzf#vim#grep(s:rg_c_symbol_command, 1, copy(s:fzf_options), 0)
command! CTypes :call fzf#vim#grep(s:rg_c_type_command, 1, copy(s:fzf_options), 0)
command! CFunctions :call fzf#vim#grep(s:rg_c_function_command, 1, copy(s:fzf_options), 0)
command! CSymbolsInFile :call fzf#vim#grep(substitute(s:rg_c_symbol_command_in_file, '%%', expand("%"), "g"), 1, copy(s:fzf_options), 0)
...
command! CSharpTypes :call fzf#vim#grep(s:rg_csharp_type_command, 1, copy(s:fzf_options), 0)
command! CSharpiOSTypes :call fzf#vim#grep(s:rg_csharp_ios_type_command, 1, copy(s:fzf_options), 0)
command! CSharpimacOSTypes :call fzf#vim#grep(s:rg_csharp_macos_type_command, 1, copy(s:fzf_options), 0)
